...
class VisitronNDMaximumIntensityProjectionGenerationAlgorithm(MaximumIntensityProjectionGenerationAlgorithm):
    '''
    Custom MaximumIntensityProjectionGenerationAlgorithm for Visitron ND datasets
    ...
    def imageToBeIgnored(self, image):
        ...
        in VisitronNDCompositeDatasetConfig. Here we prevent the base 
