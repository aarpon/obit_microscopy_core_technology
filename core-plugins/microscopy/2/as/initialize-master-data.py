...
prop_type_MICROSCOPY_ACCESSORY_FILE_NAME = tr.getOrCreateNewPropertyType('MICROSCOPY_ACCESSORY_FILE_NAME', DataType.VARCHAR)
...
assignment_DATA_SET_MICROSCOPY_ACCESSORY_FILE_MICROSCOPY_ACCESSORY_FILE_NAME = tr.assignPropertyType(data_set_type_MICROSCOPY_ACCESSORY_FILE, prop_type_MICROSCOPY_ACCESSORY_FILE_NAME)
