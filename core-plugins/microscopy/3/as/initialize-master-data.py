...
assignment_DATA_SET_MICROSCOPY_ACCESSORY_FILE_MICROSCOPY_ACCESSORY_FILE_NAME.setPositionInForms(2)
...
assignment_DATA_SET_MICROSCOPY_IMG_CONTAINER_MICROSCOPY_IMG_CONTAINER_NAME.setMandatory(False)
...
assignment_SAMPLE_MICROSCOPY_SAMPLE_TYPE_MICROSCOPY_SAMPLE_NAME.setPositionInForms(2)
